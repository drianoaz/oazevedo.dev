...
export function BlogContent({ mdxSource }: ContentProps) {
  ...
  return (
    <main className="mx-auto grid grid-cols-[1fr_auto_1fr]">
      <header className="col-start-2 col-end-3 mx-auto prose prose-xl px-4 pt-12 pb-24 prose-invert">
      ...
      <article className="col-start-2 row-start-2 mx-auto prose prose-xl p-4 prose-invert">
